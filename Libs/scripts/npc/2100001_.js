...
function action(mode, type, selection) {
    ...
    if (status == 0 && mode == 1) {
        ...
        var options = new Array("融合母礦","融合寶石","Refine a rare jewel","Refine a crystal ore","Create materials","Create Arrows");
        ...
        if (selectedType == 0){ //mineral refine
            ...
            var minerals = new Array ("青銅","Steel","Mithril","Adamantium","Silver","Orihalcon","Gold");
